<nav class="navbar bg-body-tertiary mt-2">
    <div class="container-fluid">
        <a class="navbar-brand">
            <span class="toggle-btn" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
        ...
        <ul class="ms-auto ms-md-0 me-3 me-lg-4">
            <div class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li><hr class="dropdown-divider" /></li>
                    <li><form id="logout-form" action="{{ route('logout',Auth::id()) }}" method="POST" style="display: none;">
                        @csrf
                        </form>
