        ...
        <div class="col-md-4">
            <div class="card shadow">
                <div class="mt-4 d-flex justify-content-center">
                    <img id="previewImage" src="{{ asset('storage/' . $brand->logo) }}" alt="brand Image" class="img-fluid" style="width: 200px; height: 140px;">
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('brand.update',$brand->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-2 d-flex justify-content-center">
                            ...
                            <input type="file" name="logo" id="logo" style="display:none;" accept="image/*" onchange="previewImage(event)">
                        </div>
                        <div class="mb-2">
