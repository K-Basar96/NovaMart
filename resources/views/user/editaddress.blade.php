...
@section('content')
    ...
    <div class="container my-3 justify-content-centre">
        <div class="row justify-content-center">
            <h1 class="mb-4">Update Address</h1>
                ...
                <div class="container col-6">
                    <div class="form-floating mb-3">
                        <input type="text" required placeholder="recipient"
                            ...
                            value="{{ old('recipient', $address->recipient) }}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" required placeholder="recipient_number"
                            ...
                            name="recipient_number" value="{{ old('recipient_number', $address->recipient_number) }}">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="mb-3 w-100 me-2">
                            ...
                            <input type="text" maxlength="8" id="exact_locale" name="exact_locale"
                                ...
                                value="{{ old('exact_locale', $address->exact_locale) }}">
                            @error('exact_locale')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3 w-100">
                            ...
                            <input type="text" required placeholder="Type of Address"
                                ...
                                name="address_type" value="{{ old('address_type', $address->address_type) }}">
                            @error('address_type')
                                <div class="invalid-feedback">{{ $message }} </div>
                            @enderror
                        </div>
                    ...
                    <div class=" mb-3">
                        <input type="checkbox" {{ $address->is_default ? 'checked' : '' }} class="form-check-input"
